...
//==============================================================================
const juce::String TfgAudioProcessor::getName() const
{
...
const juce::String TfgAudioProcessor::getProgramName (int index)
{
    return {};
}

void TfgAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void TfgAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* TfgAudioProcessor::createEditor()
{
    return new TfgAudioProcessorEditor (*this);
}

//==============================================================================
void TfgAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
